                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                            <tr>
                                                <td><strong>Ticket number:</strong> {{$data['uid']}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="btn btn-primary"><a href="{{$data['url']}}" target="_blank">View Ticket</a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                        ...
                                        <p>Thank you!</p>
                                        <p>Best regards, <br/>{{$data['sender_name']}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content-block powered-by">
                                © 2022 <a href="http://helpdesk.injazatsoftware.net">HelpDesk</a> - All rights reserved.
                            </td>
                        </tr>
                    </table>
                </div>
